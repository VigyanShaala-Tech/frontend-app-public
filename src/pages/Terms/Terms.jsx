...
import messages from './terms.message';
import './Terms.scss';
    ...
    <div className="terms-page py-5">
      <div className="container">
        ...
        <div className="terms-container">
          <div className="bg-white terms-content">

            {/* <p>
              {formatMessage(messages['terms.section1.intro'])}
              <strong>{formatMessage(messages['terms.section1.website'])}</strong>
              {formatMessage(messages['terms.section1.rest'])}
              <strong>{formatMessage(messages['terms.section1.application'])}</strong>
              {formatMessage(messages['terms.section1.platform'])}
              <strong>{formatMessage(messages['terms.section1.platformBold'])}</strong>
              {formatMessage(messages['terms.section1.platformRest'])}
            </p>

            <p>
              {formatMessage(messages['terms.section2.learners'])}
              <strong>{formatMessage(messages['terms.section2.learnersBold'])}</strong>
              {formatMessage(messages['terms.section2.learnersRest'])}
              <a href="/privacy">{formatMessage(messages['terms.section2.privacyLink'])}</a>
              {formatMessage(messages['terms.section2.othersRest'])}
            </p>

            <p>
              {formatMessage(messages['terms.section3.creator'])}
              <strong>{formatMessage(messages['terms.section3.creatorBold'])}</strong>
              {formatMessage(messages['terms.section3.creatorRest'])}
            </p>

            <p>{formatMessage(messages['terms.section4.accept'])}</p>

            <p>{formatMessage(messages['terms.section5.disagree'])}</p>

            <p>
              <strong>{formatMessage(messages['terms.section6.accessTitle'])}</strong> {formatMessage(messages['terms.section6.accessContent'])}
            </p>
            <p>{formatMessage(messages['terms.section6.contentDefinition'])}</p>
            <p>{formatMessage(messages['terms.section6.publicForum'])}</p>

            <p><strong>{formatMessage(messages['terms.section7.title'])}</strong></p>
            <p>{formatMessage(messages['terms.section7.content'])}</p>
            <p>{formatMessage(messages['terms.section7.restrictionsIntro'])}</p>
            <ul>
              <li>{formatMessage(messages['terms.section7.restrictionA'])}</li>
              <li>{formatMessage(messages['terms.section7.restrictionB'])}</li>
              <li>{formatMessage(messages['terms.section7.restrictionC'])}</li>
              <li>{formatMessage(messages['terms.section7.restrictionD'])}</li>
              <li>{formatMessage(messages['terms.section7.restrictionE'])}</li>
              <li>{formatMessage(messages['terms.section7.restrictionF'])}</li>
            </ul>
            <p>{formatMessage(messages['terms.section7.creatorContent'])}</p>
            <p>{formatMessage(messages['terms.section7.termination'])}</p>

            <p><strong>{formatMessage(messages['terms.section8.title'])}</strong></p>
            <p>{formatMessage(messages['terms.section8.content'])}</p>
            <p>{formatMessage(messages['terms.section8.rights'])}</p>

            <p><strong>{formatMessage(messages['terms.section9.title'])}</strong></p>
            <p>{formatMessage(messages['terms.section9.content'])}</p>
            <ol type="a">
              <li>{formatMessage(messages['terms.section9.a'])}</li>
              <li>{formatMessage(messages['terms.section9.b'])}</li>
              <li>{formatMessage(messages['terms.section9.c'])}</li>
              <li>{formatMessage(messages['terms.section9.d'])}</li>
              <li>{formatMessage(messages['terms.section9.e'])}</li>
              <li>{formatMessage(messages['terms.section9.f'])}</li>
              <li>{formatMessage(messages['terms.section9.g'])}</li>
              <li>{formatMessage(messages['terms.section9.h'])}</li>
              <li>{formatMessage(messages['terms.section9.i'])}</li>
              <li>{formatMessage(messages['terms.section9.j'])}</li>
              <li>{formatMessage(messages['terms.section9.k'])}</li>
            </ol>

            <p><strong>{formatMessage(messages['terms.section10.title'])}</strong></p>
            <p>{formatMessage(messages['terms.section10.content'])}</p>

            <p><strong>{formatMessage(messages['terms.section11.title'])}</strong></p>
            <p>{formatMessage(messages['terms.section11.content'])}</p>

            <p><strong>{formatMessage(messages['terms.section12.title'])}</strong></p>
            <p>{formatMessage(messages['terms.section12.content'])}</p>

            <p><strong>{formatMessage(messages['terms.section13.title'])}</strong></p>
            <p>{formatMessage(messages['terms.section13.content'])}</p>

            <p><strong>{formatMessage(messages['terms.section14.title'])}</strong></p>
            <p>{formatMessage(messages['terms.section14.content'])}</p>

            <p><strong>{formatMessage(messages['terms.section15.title'])}</strong></p>
            <p>{formatMessage(messages['terms.section15.content'])}</p>

            <p><strong>{formatMessage(messages['terms.section16.title'])}</strong></p>
            <p>{formatMessage(messages['terms.section16.content'])}</p>

            <p><strong>{formatMessage(messages['terms.section17.title'])}</strong></p>
            <p>{formatMessage(messages['terms.section17.content'])}</p>

            <p><strong>{formatMessage(messages['terms.section18.title'])}</strong></p>
            <ol type="a">
              <li>{formatMessage(messages['terms.section18.a'])}</li>
              <li>{formatMessage(messages['terms.section18.b'])}</li>
              <li>{formatMessage(messages['terms.section18.c'])}</li>
              <li>{formatMessage(messages['terms.section18.d'])}</li>
              <li>{formatMessage(messages['terms.section18.e'])}</li>
            </ol>

            <p><strong>{formatMessage(messages['terms.section19.title'])}</strong></p>
            <p>
              {formatMessage(messages['terms.section19.content'])}
              <a href="mailto:managing.trustee@vigyanshaala.com">{formatMessage(messages['terms.section19.email'])}</a>
            </p> */}




              <div style={{"text-align": "justify"}} id="1655296462840">
                These Terms of Use set out the terms and conditions for use of this VigyanShaala International (
                ...
                <ol> 
                  ...
                  <ol type="a"> 
                    ...
                    <li> <b>Spam:</b> Posting untargeted, unwanted and repetitive content, comments or messages with an intention to spam a Public Forum or otherwise the Platform and to drive traffic from the Platform to other third-party sites is in direct violation of this Agreement. Posting links to external websites with malware and other prohibited sites is not allowed.  </li> 
                    <li> <b>Scams:</b> Any content uploaded or posted in order to trick others for their own financial gain is not allowed and we do not tolerate any practices of extortion or blackmail, either.  </li> 
                    <li> <b>Privacy violation:</b> Kindly refer to our Privacy Policy to know how to protect Your privacy and respect the privacy of other Users.  </li> 
                  ...
                  <li> <b>Links to Third Party Website:</b> Creator has not reviewed all of the sites linked to its Platform and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by the Creator of such site. Use of any such linked website is at the Your own risk.  </li> 
                  ...
                  <li> <b>Contact Us:</b> If You’ve have concerns or queries regarding this Agreement, You may write to us by email at <a href="mailto:managing.trustee@vigyanshaala.com">managing.trustee@vigyanshaala.com</a>. </li> 
                </ol> 
              </div>
          </div>
        </div>
