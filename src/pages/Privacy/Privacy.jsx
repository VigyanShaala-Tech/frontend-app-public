...
import messages from './privacy.message';
import './Privacy.scss';
    ...
    <div className="privacy-page py-5">
      <div className="container">
        ...
        <h1 className="privacy-heading mb-4">
          {formatMessage(messages['privacy.title'])}
        </h1>

        <p className="privacy-subheading mb-5">
          {formatMessage(messages['privacy.subtitle'])}
        </p>

        <div className="privacy-container">
          <div className="bg-white privacy-content">

            {/* Section 1 - Intro */}
            <p>
              VigyanShaala does not share or dissimiate your Personal Data with any Entity whatsoever, and under any circumstance. Any Personal data will only be shared with your prior approval.
            </p>

            <p>
              This Privacy Policy (the <b>“Policy”</b>) governs the manner in which the Platform collects, uses, maintains and discloses information of its users. The Policy also describes the practices that We apply to such user information, user’s privacy rights and choices regarding their information. To clarify, this Policy applies to all users of the Platform (referred to as <b>“Learners”, “You”, “Your”</b>).
            </p>
            ...
            <li> <b>HOW WE USE and SHARE THE INFORMATION COLLECTED</b>  We may collect and use Your Personal Information for the following purposes:  
            <ol type="a"> 
            ...
            </ol>  Remember, you are entitled to exercise your rights as stated above only with respect to your information, including Personal Information, and not that of other Learners. Further, when we receive any requests or queries over email to the address specified in the ‘Grievances’ section below, then, as per the applicable Data Protection Laws, we may need to ask you a few additional information to verify your identity in association with the Platform and the request received. </li> 
             
            <li> <b>PROTECTION OF YOUR INFORMATION:</b>  We take all measures reasonably necessary to protect against the unauthorized access, use, alteration or destruction of Personal Information or such other data on the Platform. Our disclosure of any such information is limited to –  
            <ol type="a"> 
         ...
         <ol type="A"> 
          ...
          <li> <b>TERMS APPLICABLE IF YOU ARE A RESIDENT OF UNITED KINGDOM (UK), A EUROPEAN UNION (EU) COUNTRY OR EUROPEAN ECONOMIC AREA (EEA)</b>  <b><u>Your Rights:</u></b> If you are located in the United Kingdom (UK) or European Union (EU) or European Economic Area (EEA), you have the following rights under the UK and EU General Data Protection Regulation (GDPR) respectively. All requests should be sent to the address noted in the <b>“Grievances”</b> section above, and we will fulfil requests to the extent required by applicable law. 
           <ol> 
           ...
           </ol>  We collect and process Personal Information about you only where we have a legal rationale to do so. Specific legal rationale applied for the same will depend on the type of Personal Information collected and the context in which the same is being processed, including the Services involved.  </li> 
          <li> <b>TERMS APPLICABLE IF YOU ARE A CALIFORNIA STATE RESIDENT </b>  If you are a California state resident, then you have the following rights to the extent, and in the manner, set out in the CCPA:  
           <ol> 
           ...
           </ol>  The above rights, the manner in which you can exercise the same and the category of and the manner in which we collect your information, are detailed below. </li> 
         </ol>

         <ol> 
          <li> <b>CCPA NOTICE AT COLLECTION:</b>  For purposes of the CCPA, in collecting the information described above, we collect the categories of Personal Information listed below from you:  
           <ol type="a"> 
          ...
          <li> <b>CCPA DATA PRACTICES DURING THE LAST 12 MONTHS:</b>  
           <ol type="a"> 
